...
# مهم:
# ریشه سایت پنل باید admin.html باشد.
# اینجا عمداً index.html نمایش داده نمی‌شود.
...
def index_html():
    ...
    # اگر کسی داخل پنل به index.html دسترسی مستقیم خواست،
    # فایل موجود را نمایش می‌دهیم.
    return send_from_directory(
        BASE_DIR,
        "index.html"
    )
